...
BEGIN {
    ...
    require '/Volumes/lxc/master_harmony/harmony2/third_party/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Volumes/lxc/master_harmony/harmony2/third_party/openssl/test/fips-and-base.cnf';
    shift;
