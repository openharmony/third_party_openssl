...
BEGIN {
    ...
    require '/mnt/data/f00574894/openssl/openssl3.0.7/openssl-mingw64/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/mnt/data/f00574894/openssl/openssl3.0.7/openssl-mingw64/test/fips-and-base.cnf';
    shift;
